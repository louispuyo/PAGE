...
class Alien:
    ...
    image:str, weapon_image:str):
        ...
        self.image = f"{current_dir}/img/png/"+image
        self.weapon_image = f"{current_dir}/img/png/"+weapon_image
...
class Weapons:
    ...
    bullet_degat, missile_degat, bullet_image:str, missile_image:str):
        ...
        self.bulletImg = pygame.image.load(f'{current_dir}/img/png/{bullet_image}')
        self.missileImg = pygame.image.load(f'{current_dir}/img/png/{missile_image}')
...
class Personnage:
    ...
    def move(self):
        ...
        if pressed[pygame.K_RIGHT] and self.x < 1000: self.x += self.speed_right
